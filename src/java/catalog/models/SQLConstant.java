...
public class SQLConstant {
    ...
    protected static final String CREATE_AUTHOR = "INSERT INTO author"
            + "(author_id, author_lastname, author_firstname) VALUES (DEFAULT,?,?)";

    protected static final String UPDATE_USER_BY_ID = "UPDATE author SET author_lastname = ? AND "
            + "author_firstname = ? WHERE author_id = ?";

    protected static final String DELETE_AUTHOR = "DELETE author WHERE "
            + "author_id = ?";
